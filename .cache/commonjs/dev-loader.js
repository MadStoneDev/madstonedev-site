...
class DevLoader extends _loader.BaseLoader {
  ...
  handleSliceQueryResultHotUpdate(msg) {
    ...
    // processed data
    {
      ...
      if (
        !(0, _isEqual.default)(
          newResult === null || newResult === void 0
            ? void 0
            : (_newResult$result = newResult.result) === null ||
              _newResult$result === void 0
            ? void 0
            : _newResult$result.data,
          cachedResult === null || cachedResult === void 0
            ? void 0
            : cachedResult.data
        ) ||
        !(0, _isEqual.default)(
          newResult === null || newResult === void 0
            ? void 0
            : (_newResult$result2 = newResult.result) === null ||
              _newResult$result2 === void 0
            ? void 0
            : _newResult$result2.sliceContext,
          cachedResult === null || cachedResult === void 0
            ? void 0
            : cachedResult.sliceContext
        )
      ) {
        ...
        const mergedResult = {
          ...
          data:
            newResult === null || newResult === void 0
              ? void 0
              : (_newResult$result3 = newResult.result) === null ||
                _newResult$result3 === void 0
              ? void 0
              : _newResult$result3.data,
          sliceContext:
            newResult === null || newResult === void 0
              ? void 0
              : (_newResult$result4 = newResult.result) === null ||
                _newResult$result4 === void 0
              ? void 0
              : _newResult$result4.sliceContext,
        };
  ...
  markAsStale = (dirtyQueryId) => {
    ...
    // due to our special handling of it in App.jsx (loader.isPageNotFound check)
