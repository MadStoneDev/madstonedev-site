  ...
  return (
    <Layout>
      ...
      <main className={'w-full border-b-2 border-primary'}>
        ...
        <ul className={'ml-6 pb-6 list-disc font-light'}>
          ...
          <li className={'pb-1'}>
            <p className="pb-5 font-light">
              ...
              &quot;Our&quot; in this Agreement) refers to LFToolbox.
            </p>
          </li>
          <li className={'pb-1'}>
            <p className="pb-5 font-light">
        ...
        <h3 className={'pb-1 font-bold'}>Retention of Your Personal Data</h3>
        <p className="pb-5 font-light">
        ...
        <h3 className={'pb-1 font-bold'}>Transfer of Your Personal Data</h3>
        <p className="pb-5 font-light">
        ...
        <h3 className={'pb-1 font-bold'}>Disclosure of Your Personal Data</h3>
        ...
        <h3 className={'pb-1 font-bold'}>Security of Your Personal Data</h3>
        <p className="pb-5 font-light">
        ...
        <h2 className={'pb-3 text-xl font-bold'}>Children's Privacy</h2>
        <p className="pb-5 font-light">
        ...
        <p className="pb-5 font-light">
          ...
          us from the{' '}
          <a href={'/contact'} className={'font-base underline'}>
            Contact Page
          </a>
        </p>
      </main>
