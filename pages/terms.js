  ...
  return (
    <Layout>
      ...
      <main className="w-full border-b-2 border-primary">
        ...
        <p className={'pb-5 italic font-bold'}>Last updated: 24 July, 2023</p>
        ...
        <ul className={'ml-6 pb-6 list-disc font-light'}>
          ...
          <li className={'pb-1'}>
            <p className="pb-5 font-light">
              ...
              in this Agreement) refers to OMDESTI.
            </p>
          </li>
          <li className={'pb-1'}>
            <p className="pb-5 font-light">
        ...
        <h2 className={'pb-3 text-xl font-bold'}>Acknowledgment</h2>
        <p className="pb-5 font-light">
        ...
        <h2 className={'pb-3 text-xl font-bold'}>Links to Other Websites</h2>
        <p className="pb-5 font-light">
        ...
        <h2 className={'pb-3 text-xl font-bold'}>Termination</h2>
        <p className="pb-5 font-light">
        ...
        <h2 className={'pb-3 text-xl font-bold'}>Limitation of Liability</h2>
        <p className="pb-5 font-light">
        ...
        <h2 className={'pb-3 text-xl font-bold'}>Governing Law</h2>
        <p className="pb-5 font-light">
        ...
        <h2 className={'pb-3 text-xl font-bold'}>Disputes Resolution</h2>
        <p className="pb-5 font-light">
        ...
        <h2 className={'pb-3 text-xl font-bold'}>Severability and Waiver</h2>
        <h3 className={'pb-1 font-bold'}>Severability</h3>
        <p className="pb-5 font-light">
        ...
        <h3 className={'pb-1 font-bold'}>Waiver</h3>
        <p className="pb-5 font-light">
        ...
        <h2 className={'pb-3 text-xl font-bold'}>Translation Interpretation</h2>
        <p className="pb-5 font-light">
        ...
        <h2 className={'pb-3 text-xl font-bold'}>Contact Us</h2>
        <p className="pb-5 font-light">
